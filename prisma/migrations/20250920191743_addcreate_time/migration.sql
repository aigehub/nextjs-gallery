...
INSERT INTO "new_Girl" ("address", "age", "api_url", "bust", "c_jd", "c_number", "c_wd", "city", "code_ref", "girl_id", "height", "id", "name", "p_jd", "p_number", "p_wd", "phone", "photo", "photo1", "photo2", "photo3", "photo4", "photo5", "photo6", "price", "province", "qq", "rank_bust", "remarks", "skill", "state_ref", "video", "video1", "video2", "vx", "web_url", "weight", "xl", "yn") SELECT "address", "age", "api_url", "bust", "c_jd", "c_number", "c_wd", "city", "code_ref", "girl_id", "height", "id", "name", "p_jd", "p_number", "p_wd", "phone", "photo", "photo1", "photo2", "photo3", "photo4", "photo5", "photo6", "price", "province", "qq", "rank_bust", "remarks", "skill", "state_ref", "video", "video1", "video2", "vx", "web_url", "weight", "xl", "yn" FROM "Girl";
DROP TABLE "Girl";
...
INSERT INTO "new_ZhizunDistrict" ("district_id", "district_name", "id") SELECT "district_id", "district_name", "id" FROM "ZhizunDistrict";
...
INSERT INTO "new_ZhizunTag" ("id", "tag_id", "tag_name") SELECT "id", "tag_id", "tag_name" FROM "ZhizunTag";
