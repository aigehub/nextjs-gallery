...
INSERT INTO "new_Girl" ("address", "age", "api_url", "bb", "bust", "c_jd", "c_number", "c_wd", "city", "code_ref", "create_time", "create_timestamps", "girl_id", "height", "id", "name", "p_jd", "p_number", "p_wd", "phone", "photo", "photo1", "photo2", "photo3", "photo4", "photo5", "photo6", "price", "province", "qh", "qq", "rank_bust", "remarks", "skill", "state_ref", "video", "video1", "video2", "vx", "web_url", "weight", "xl", "yn") SELECT "address", "age", "api_url", "bb", "bust", "c_jd", "c_number", "c_wd", "city", "code_ref", "create_time", "create_timestamps", "girl_id", "height", "id", "name", "p_jd", "p_number", "p_wd", "phone", "photo", "photo1", "photo2", "photo3", "photo4", "photo5", "photo6", "price", "province", "qh", "qq", "rank_bust", "remarks", "skill", "state_ref", "video", "video1", "video2", "vx", "web_url", "weight", "xl", "yn" FROM "Girl";
DROP TABLE "Girl";
...
INSERT INTO "new_XChinaSigou" ("album_id", "create_time", "create_timestamps", "girl_name", "id", "image_base_url", "image_count", "subs", "title", "video_count") SELECT "album_id", "create_time", "create_timestamps", "girl_name", "id", "image_base_url", "image_count", "subs", "title", "video_count" FROM "XChinaSigou";
DROP TABLE "XChinaSigou";
ALTER TABLE "new_XChinaSigou" RENAME TO "XChinaSigou";
